...
function Make-GradString
{
    ...
    $string = "--gradient--electric"+"$cnt"+": linear-gradient("+"90deg,#"+(Make-HexCode)+" 0%,#"+(Make-HexCode)+" 34%,#"+(Make-HexCode)+" 66%,#"+(Make-HexCode)+" 100%"+");"
    $string
}
...
New-Item -Path ".\Gradients4Colors.html" -Value $htmltext -Force
