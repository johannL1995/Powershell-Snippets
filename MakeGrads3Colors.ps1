# Creates an HTML file with 10 colored gradients made of 3 colors
...
function Make-GradString
{
    ...
    $string = "--gradient--electric"+"$cnt"+": linear-gradient("+"90deg,#"+(Make-HexCode)+" 0%,#"+(Make-HexCode)+" 50%,#"+(Make-HexCode)+" 100%"+");"
    $string
}
...
New-Item -Path ".\Gradients3Colors.html" -Value $htmltext -Force
